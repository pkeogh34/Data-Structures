...
public class LinkedBinaryTree<E> extends AbstractBinaryTree<E> {
    ...
    /**
     * Returns the Interfaces.Position of p's left child (or null if no child exists).
     *
     * @param p A valid Interfaces.Position within the tree
     * @return the Interfaces.Position of the left child (or null if no child exists)
     * @throws IllegalArgumentException if p is not a valid Interfaces.Position for this tree
     */
    @Override
    ...
    /**
     * Returns the Interfaces.Position of p's right child (or null if no child exists).
     *
     * @param p A valid Interfaces.Position within the tree
     * @return the Interfaces.Position of the right child (or null if no child exists)
     * @throws IllegalArgumentException if p is not a valid Interfaces.Position for this tree
     */
    @Override
    ...
    /**
     * Places element e at the root of an empty tree and returns its new Interfaces.Position.
     *
     * @param e the new element
     * @return the Interfaces.Position of the new element
    ...
    /**
     * Creates a new left child of Interfaces.Position p storing element e and returns its
     * Interfaces.Position.
     *
     * @param p the Interfaces.Position to the left of which the new element is inserted
     * @param e the new element
     * @return the Interfaces.Position of the new element
     * @throws IllegalArgumentException if p is not a valid Interfaces.Position for this tree
    ...
    /**
     * Creates a new right child of Interfaces.Position p storing element e and returns its
     * Interfaces.Position.
     *
     * @param p the Interfaces.Position to the right of which the new element is inserted
     * @param e the new element
     * @return the Interfaces.Position of the new element
     * @throws IllegalArgumentException if p is not a valid Interfaces.Position for this tree.
    ...
    /**
     * Replaces the element at Interfaces.Position p with element e and returns the replaced
     * element.
     *
     ...
     * leaf Interfaces.Position p. As a side effect, t1 and t2 are set to empty trees.
     *
