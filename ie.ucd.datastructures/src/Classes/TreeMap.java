...
import Abstract.AbstractSortedMap;
...
public class TreeMap<K, V> extends AbstractSortedMap<K, V> {
	...
	/**
	 * A specialized version of the Classes.LinkedBinaryTree class with additional mutators
	...
	protected static class BalanceableBinaryTree<K, V> extends LinkedBinaryTree<Entry<K, V>> {
		...
		// this extends the inherited Classes.LinkedBinaryTree.Node class
...
// TODO
		...
		/**
		 * Rotates Interfaces.Position p above its parent. Switches between these configurations,
...
// TODO
		...
		/**
		 *
		 * Returns the Interfaces.Position that becomes the root of the restructured subtree.
		 *
	...
	// We reuse the Classes.LinkedBinaryTree class. A limitation here is that we only use
	// the key.
	// protected Classes.LinkedBinaryTree<Interfaces.Entry<K, V>> tree = new Classes.LinkedBinaryTree<Interfaces.Entry<K,
	// V>>();
	protected BalanceableBinaryTree<K, V> tree = new BalanceableBinaryTree<>();

	/** Constructs an empty map using the natural ordering of keys. */
	public TreeMap() {
		super(); // the Abstract.AbstractSortedMap constructor
	...
	public TreeMap(Comparator<K> comp) {
		super(comp); // the Abstract.AbstractSortedMap constructor
		tree.addRoot(null); // create a sentinel leaf as root
	}
	 ...
	 * 
	 * @param p the Interfaces.Position which was recently accessed (possibly a leaf)
	 */
...
// TODO
	 ...
	 * @return Interfaces.Position holding key, or last node reached during search
	 */
...
// TODO
	...
	/**
	 * Returns position with the minimal key in the subtree rooted at Interfaces.Position p.
	 * 
	 * @param p a Interfaces.Position of the tree serving as root of a subtree
	 * @return Interfaces.Position with minimal key in subtree
	 */
...
// TODO
	 ...
	 * 
	 * @param p a Interfaces.Position of the tree serving as root of a subtree
	 * @return Interfaces.Position with maximum key in subtree
	 */
...
// TODO
	...
	// additional behaviors of the Interfaces.SortedMap interface
	/**
