...
public class Timer {
    ...
    private static final int MIN_REPEATS = 100; // repeat the execution at least this
    private static final int MAX_REPEATS = 1000; // repeat the execution at least this

    // number of times
    private static final long MIN_SECONDS = (long) (3 * 1e9); // repeat execution of the work
