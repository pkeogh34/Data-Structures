...
/**
 * An abstract base class to ease the implementation of the Interfaces.PriorityQueue interface.
 *
...
public abstract class AbstractPriorityQueue<K,V> implements PriorityQueue<K,V> {
  ...
  /**
   * A concrete implementation of the Interfaces.Entry interface to be used within
   * a Interfaces.PriorityQueue implementation.
   */
  protected static class PQEntry<K,V> implements Entry<K,V> {
    ...
    // methods of the Interfaces.Entry interface
    public K getKey() { return k; }
    public V getValue() { return v; }

    // utilities not exposed as part of the Interfaces.Entry interface
  ...
  // instance variable for an Abstract.AbstractPriorityQueue
