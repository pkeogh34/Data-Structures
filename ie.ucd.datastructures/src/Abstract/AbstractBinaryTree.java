...
/**
 * An abstract base class providing some functionality of the Interfaces.BinaryTree interface.
 * <p>
...
public abstract class AbstractBinaryTree<E> extends AbstractTree<E>
    ...
    /**
     * Returns the Interfaces.Position of p's sibling (or null if no sibling exists).
     *
     * @param p A valid Interfaces.Position within the tree
     * @return the Interfaces.Position of the sibling (or null if no sibling exists)
