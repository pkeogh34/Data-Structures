...
/**
 * An abstract base class to ease the implementation of the Interfaces.Map interface.
 *
...
public abstract class AbstractMap<K, V> implements Map<K, V> {
	...
	/**
	 * A concrete implementation of the Interfaces.Entry interface to be used within a Interfaces.Map
	 * implementation.
	 */
	protected static class MapEntry<K, V> implements Entry<K, V> {
		...
		// public methods of the Interfaces.Entry interface
		public K getKey() {
			return k;
		}
