...
/**
 * An abstract base class providing some functionality of the Interfaces.Tree interface.
 * <p>
...
public abstract class AbstractTree<E> implements Tree<E> {
    ...
    /**
     * Returns true if Interfaces.Position p has one or more children.
     *
    ...
    /**
     * Returns true if Interfaces.Position p does not have any children.
     *
     * @param p A valid Interfaces.Position within the tree
    ...
    /**
     * Returns true if Interfaces.Position p represents the root of the tree.
     *
     * @param p A valid Interfaces.Position within the tree
    ...
    /**
     * Returns the number of children of Interfaces.Position p.
     *
     * @param p A valid Interfaces.Position within the tree
     * @return number of children of Interfaces.Position p
     * @throws IllegalArgumentException if p is not a valid Interfaces.Position for this tree.
     */
    @Override
    ...
    /**
     * Returns the number of levels separating Interfaces.Position p from the root.
     *
     * @param p A valid Interfaces.Position within the tree
     * @throws IllegalArgumentException if p is not a valid Interfaces.Position for this tree.
     */
    ...
    /**
     * Returns the height of the subtree rooted at Interfaces.Position p.
     *
     * @param p A valid Interfaces.Position within the tree
     * @throws IllegalArgumentException if p is not a valid Interfaces.Position for this tree.
     */
    ...
    /**
     * Adds positions of the subtree rooted at Interfaces.Position p to the given
     * snapshot using a preorder traversal
     *
     * @param p        Interfaces.Position serving as the root of a subtree
